  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md animate-fade-in-up">
        <Link href="/login" className="inline-flex items-center gap-1.5 text-sm text-fg-muted hover:text-fg-primary transition-colors mb-8 group">
        ...
        <div className="glass-card p-8">
          {sent ? (
            <div className="text-center py-4 animate-fade-in">
              ...
              <h1 className="text-xl font-bold text-fg-primary mb-2">Email enviado</h1>
              <p className="text-fg-secondary text-sm leading-relaxed mb-6">
                Si existe una cuenta con <span className="text-fg-primary font-medium">{email}</span>,
            ...
            <div className="animate-fade-in">
              <h1 className="text-2xl font-bold text-fg-primary mb-1">Recuperar contraseña</h1>

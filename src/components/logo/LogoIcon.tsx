    ...
    >
      <defs>
        <radialGradient id="tb-core" cx="50%" cy="50%" r="50%">
          <stop offset="0%"   stopColor="#DBFF60" />
          <stop offset="100%" stopColor="#8FD43A" />
        </radialGradient>
      ...
      <g className={animated ? 'logo-orbit-outer' : undefined}>
        <circle cx="20" cy="20" r="18" stroke="#C8FF47" strokeWidth="0.6"
          fill="none" strokeDasharray="5 3.5" opacity="0.22" />
      </g>

      {/* Inner orbit + satellite dot — counter-clockwise */}
      <g className={animated ? 'logo-orbit-inner' : undefined}>
        <circle cx="20" cy="20" r="13" stroke="#C8FF47" strokeWidth="0.9"
          fill="none" opacity="0.48" />
        {/* Satellite at 12 o'clock of the inner ring */}
        <circle cx="20" cy="7" r="1.8" fill="#C8FF47" filter="url(#tb-glow)" />
      </g>

      {/* Core — the boost canister */}
      <circle cx="20" cy="20" r="9" fill="url(#tb-core)" filter="url(#tb-glow)" />

      {/* Double chevron UP — dark on lime */}
      <path d="M15 22.5l5-5 5 5"
        stroke="#050505" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M15 26l5-5 5 5"
        stroke="#050505" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"
        opacity="0.32" />
    </svg>
  )
}
